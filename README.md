# px-file-upload [![Build Status](https://travis-ci.org/predixdesignsystem/px-file-upload.svg?branch=master)](https://travis-ci.org/predixdesignsystem/px-file-upload)
